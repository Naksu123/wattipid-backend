...
class AuditController {
    ...
    public function getSystemAuditLogs($authenticatedUser) {
        ...
        try {
            ...
            $activityQuery = "SELECT id, 'activity' as log_type, action_type, description, entity_type as table_affected, NULL as old_value, metadata as new_value, NULL as ip_address, created_at, actor_id
                              FROM activity_logs 
                              ORDER BY created_at DESC LIMIT 50";
